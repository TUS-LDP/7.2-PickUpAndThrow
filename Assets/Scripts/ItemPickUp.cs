...
public class ItempPickUp : MonoBehaviour
{
    ...
    public InputController inputVars;
    ...
    void Start()
    {
        inputVars = GameManager.Instance.GetComponent<InputController>();
    }
    ...
    void Update()
    {
        ...
        if (inputVars.dropItem)
        {
            DropItem();
        }

        if (inputVars.rotateItem)
        {
            RotateItem();
        }
    ...
    private void RotateItem()
    {
        if (item != null)
        {
            float mouseX = inputVars.look.x * rotationSpeed * Time.deltaTime;
            float mouseY = inputVars.look.y * rotationSpeed * Time.deltaTime;
